...
@Client.on_message(
    command(["userbotjoin", f"join"]) & ~filters.private & ~filters.bot
)
...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "✅ USERBOT ENTER IN CHATGROUP")
        ...
        if not admin.can_manage_voice_chats:
            ...
            return await user.send_message(chat_id, "✅ MUSIC BOT ALREADY HEAR")
        return await user.send_message(chat_id, "✅ MUSIC BOT ALREADY HEAR")
